...
![Portfolio](https://img.shields.io/badge/Portfolio-agustin.agustinynatalia.site-0EA5E9?style=for-the-badge&logo=safari&logoColor=white)
![LinkedIn](https://img.shields.io/badge/LinkedIn-agustin--peralta--guarin-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)
![Email](https://img.shields.io/badge/Email-apg%40urpeailab.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)
</div>
---
Lo que hago
Diseño y opero agentes LLM, pipelines de automatización y sistemas self-hosted que reemplazan operaciones manuales por flujos inteligentes, escalables y auditables. Lidero infraestructura propia (no SaaS), de la arquitectura al deploy.
Agentes de IA con Claude / Gemini + LangGraph + tool use sobre múltiples sistemas
Automatizaciones end-to-end en n8n, conectando GoHighLevel, BigQuery, Telegram, GHL, GMail, etc.
Infra self-hosted en Coolify + Docker (Postgres, n8n, FastAPI, servicios on-demand)
...
Monica Designer (live)	API SaaS: convierte un business plan en brandbook completo (logo 4K + PDF + 4 flyers + membrete) en ~7 min usando IA generativa	FastAPI · Gemini · Docker · Pango/Cairo
