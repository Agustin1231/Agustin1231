...
| **[FlowDeck](https://github.com/Agustin1231/flowdeck)** | PWA gestor multi-instancia de n8n — administra varias instancias desde un dashboard, prende/apaga workflows, ve ejecuciones. API keys cifradas AES-256-GCM en backend. | Node · React · PWA · Docker |
